...
if ((-not $global:PSVersionTable.Platform) -or ($global:PSVersionTable.Platform -eq "Win32NT")) {
  ...
  if( Test-Path "C:\Program Files\Unity Hub\Unity Hub.exe" )
  {
    ...
    pwsh -NoLogo -NonInteractive -NoProfile -Command "'C:\Program Files\Unity Hub\Unity Hub.exe -- --headless help'"
  }
  else
  {
...
elseif ($global:PSVersionTable.OS.Contains("Darwin")) {
  ...
  pwsh -NoLogo -NonInteractive -NoProfile -Command "'/Applications/Unity\ Hub.app/Contents/MacOS/Unity\ Hub -- --headless help'"
}
elseif ($global:PSVersionTable.OS.Contains("Linux")) {
  ...
  pwsh -NoLogo -NonInteractive -NoProfile -Command "'Unity\ Hub.AppImage -- --headless help'"
}
